...
**Read the SRD online: <https://blarfinaround.github.io/deezix-srd/>**
...
The SRD is built with [Quarto](https://quarto.org/).
...
Deezix is released under the [Creative Commons Attribution 4.0 International License (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/). See `src/license.md` for attribution requirements.
